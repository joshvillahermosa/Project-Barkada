# Project Barkada App Repository
> _Let's plan awesome stuff together_
...
### `npm commit`
Will run a [commitizen](https://github.com/commitizen/cz-cli) script to create meaningful commit messages.
